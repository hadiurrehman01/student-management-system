            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="Userdd">
                                        <router-link class="dropdown-item" to="/dashboard"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></router-link>
                        ...
                        <li class="p-15 m-t-10 sidebar-item"><a href="javascript:void(0)" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-plus-square"></i> <span class="hide-menu m-l-5">Create New</span> </a></li>
                        <!-- User Profile-->
                        
                        <li class="sidebar-item"> 
                            <router-link class="sidebar-link waves-effect waves-dark sidebar-link" to="/dashboard"><i class="mdi mdi-account-network"></i><span class="hide-menu">Dashboard</span></router-link>
                        </li>
                        <li  class="sidebar-item">
                            <router-link class="sidebar-link waves-effect waves-dark sidebar-link" to="/profile"><i class="mdi mdi-account-network"></i><span class="hide-menu">Profile</span></router-link>
                        </li>
                        <li  class="sidebar-item">
                            <router-link class="sidebar-link waves-effect waves-dark sidebar-link" to="/courses"><i class="mdi mdi-border-all"></i><span class="hide-menu">Courses</span></router-link>
                        </li>

                                <!-- <a  href="index.html" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i></a></li> -->
